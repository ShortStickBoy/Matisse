...
public class CheckView extends View {
    ...
    private static final int SIZE = 29; // dp
    private static final int MARGIN = 7; // dp
...
//        canvas.drawCircle((float) SIZE * mDensity / 2, (float) SIZE * mDensity / 2, STROKE_RADIUS * mDensity, mStrokePaint);
        ...
        // draw round rect
        canvas.drawRoundRect(MARGIN * mDensity, MARGIN * mDensity, (SIZE - MARGIN) * mDensity, (SIZE - MARGIN) * mDensity, 5, 5, mCoverPaint);
        canvas.drawRoundRect(MARGIN * mDensity, MARGIN * mDensity, (SIZE - MARGIN) * mDensity, (SIZE - MARGIN) * mDensity, 5, 5, mStrokePaint);
...
//                canvas.drawCircle((float) SIZE * mDensity / 2, (float) SIZE * mDensity / 2, BG_RADIUS * mDensity, mBackgroundPaint);
                canvas.drawRoundRect(MARGIN * mDensity, MARGIN * mDensity, (SIZE - MARGIN) * mDensity, (SIZE - MARGIN) * mDensity, 5, 5, mBackgroundPaint);
                initTextPaint();
...
//                canvas.drawCircle((float) SIZE * mDensity / 2, (float) SIZE * mDensity / 2, BG_RADIUS * mDensity, mBackgroundPaint);
    ...
    private void initCoverPaint() {
        if (mCoverPaint == null) {
            ...
            mCoverPaint.setColor(Color.parseColor("#0F000000"));
        }
    }
